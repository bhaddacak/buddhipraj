...
อันนี้เป็นลักษณะเฉพาะของภาษาโบราณตระกูลนี้ เมื่อคำนามใดแปรรูปเป็น nom. แล้วคำนั้นจะมีความหมายเป็นประธานของประโยค แม้คำกริยาจะไม่ปรากฏก็ถือว่าเป็นประโยคที่สมบูรณ์แล้ว ในตำราบาลีเรียกประโยคแบบนี้ว่า ลิงคัตถะ เราจะไม่ใช้คำนี้แต่จะเรียกว่า *ประโยคนามโดด* แทน คือเป็นประโยคที่มีแต่คำนามหลัก (อาจจะมีคำขยายด้วยก็ได้แต่เรายังไม่พูดถึง ดูที่ [นามกับบทขยาย](/docs/pali/basic/adjective.html))

ประโยคแบบนี้ส่วนมากจะใช้เป็นหัวเรื่อง บางครั้งเป็นการระบุสถานะของสิ่งใดสิ่งหนึ่งว่ามีอยู่ ตัวอย่างเช่น dārako แปลว่า เด็กชายคนหนึ่ง (มีอยู่) ในคำอธิบายของครูบาลีทั่วไปจะบอกว่า ถ้าไม่มีคำกริยาเวลาแปลให้เพิ่ม verb to be หรือ "เป็น/อยู่/คือ" เข้าไป ในบาลีคือ hoti (ดูที่ [เป็น/อยู่/คือ](/docs/pali/basic/verb-to-be.html)) นั่นคือเวลาเห็น dārako มาโดด ๆ ให้มองเป็น dārako hoti (there is a boy)
